...
import { de_DescribeEntitiesDetectionV2JobCommand, se_DescribeEntitiesDetectionV2JobCommand, } from "../protocols/Aws_json1_1";
export { $Command };
export class DescribeEntitiesDetectionV2JobCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DescribeEntitiesDetectionV2JobCommand.getEndpointParameterInstructions()));
